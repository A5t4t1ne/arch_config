...
Die 32 Bit Version des unobtimierten Codes ist, nebst den offensichtlichen Unterschieden wie Register-Grössen, Jump-Offsets etc., sehr ähnlich zur 64bit Version. Die Statements sind oftmals die Gleichen, mit den gleichen Abläufen, Vergleichen und die Proportionen der einzelnen Funktionenslängen stimmen auch überein. Die 32 Bit Funktionen sind aber alle ein wenig länger, was mehrheitlich an den zusätzlichen load/save-operationen liegt. Ein Beispiel dafür sind die Funktionsargumente, obwohl im unten gezeigten Beispiel der Unterschied nur 1 Instruktion mehr ist.

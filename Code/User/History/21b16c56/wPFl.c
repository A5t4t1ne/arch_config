...
void move_col_sel_cursor(int col)
{
    ...
    printf("\033[%dA", ROWS + ROW_OFFSET);    // Move cursor up
    printf("\033[%dC", COL_OFFSET); // Move cursor right
    printf("%c", '|');    
    printf("\033[%dD", 1);  // Move cursor left 
    printf("\033[%dB", 1);    // Move cursor down
    printf("%c", 'v');
    fflush(stdout);
...
void print_at_pos(int x, int y, char c)
{

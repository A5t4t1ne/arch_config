...
#define LINE_LEN TYPE_COL_WIDTH + N_COL_WIDTH + F_NUM_COL_WIDTH + TIME_COL_WIDTH + 4*8 + 2 // col sizes, col separators, new-line + \0
#define SYNTAX "\
Usage:\n\
\tfibonacci <n>\n\n\
Note:\n\
\tOutput is formatted statically. Which means that if certain numbers exceed a number of digits, output is formatted poorly.\n\
\tMax"
